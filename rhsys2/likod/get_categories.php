...
try {
   ...
   $sql = "SELECT category_name FROM item_categories ORDER BY category_name ASC";
   ...
   http_response_code(500);
   // 💥 FIXED: Returning 'success: false' and a 'message'
   echo json_encode(['success' => false, 'message' => 'Database query failed: Could not load categories. Details: ' . $e->getMessage()]);
}
