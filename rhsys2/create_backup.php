...
<head>
   <meta charset="UTF-8">
   <title>Create Backup - RHSYS</title>
...
<body>
      ...
      <div class="main-content">
         <div class="large-container">
            <div class="nav-links">
               ...
               <a href="restore_backup.php" class="btn btn-warning" style="margin-left: auto;">
                  🔄 Go to Restore Center
               </a>
            </div>
            ...
            <div class="backup-section">
               ...
               <p>Create a complete backup of the database. This includes all patient records, visits, users, and system
                  data.</p>

               <div class="action-buttons">
                  <button onclick="openPasswordModal('create')" class="btn backup-btn" id="backupBtn">
                     💾 Create Backup Now
                  </button>
               </div>
               ...
               <div class="backup-list" id="backupList">
                  <?php if (empty($backupFiles)): ?>
                     <div class="empty-state">
                        ...
                        <p>Click 'Create Backup Now' to generate your first file.</p>
                     </div>
                  <?php else: ?>
   ...
   <script>
      ...
      function openPasswordModal(action, filename = null) {
         pendingAction = action; // 'create', 'delete', 'download'
      ...
      function closeModal() {
         ...
         // We reset state AFTER execution, not here!
      }
      ...
      document.getElementById('modalConfirmBtn').onclick = async () => {
         ...
         switch (pendingAction) {
            ...
            case 'delete':
               ...
               break;
            case 'download': // NEW: Execution for download
      ...
      async function executeCreateBackup() {
         ...
         resultDiv.innerHTML =
            '<div class="loading">Creating backup, please wait. This may take a few minutes...</div>';
